...
const CartNavbar = (props) => {
  ...
  return (
    <>
      <div className={`hidden md:flex flex-col absolute  shadow-xl left-0 bg-[#ffffff] w-full mx-auto z-40  h-[300px] justify-between items-center duration-300 transition-all py-4 ${isMenuOpen ? 'top-10' : '-top-[500%]'}`}>
